...
if "%AutoRestart%"=="开" (if "%AutoPort%"=="开" (title [%Title%]--重启[%ReTimes%]次--端口=[%Port%]--内存=[%MinRAM%/%MaxRAM%]--Golden_Godsun制作v5.1.3) else (title [%Title%]--重启[%ReTimes%]次--内存=[%MinRAM%/%MaxRAM%]--Golden_Godsun制作v5.1.3)) else (if "%AutoPort%"=="开" (title [%Title%]--端口=[%Port%]--内存=[%MinRAM%/%MaxRAM%]--Golden_Godsun制作v5.1.3) else (title [%Title%]--内存=[%MinRAM%/%MaxRAM%]--Golden_Godsun制作v5.1.3))
...
echo #Golden_Godsun production, software version v5.1.3>>eula.txt
...
@echo.
@echo -----------------------------------------------------------------------------------
if exist "%BackupWay%\%BackupName%.7z" (del /q "%BackupWay%\%BackupName%.7z")
"%AppData%\Server Components\7-Zip\7z.exe" a -t7z "%BackupWay%\%BackupName%.7z" "%~dp0*" -r -mf -mmt -mx=9 -mhc -mhcf -ms=200m -m0=BCJ -m1=LZMA:a=2:d=25:fb=64
title 服务器备份已完成，正在重启...
@echo -----------------------------------------------------------------------------------
@echo.
@echo                          服务器备份已完成，正在重启...
